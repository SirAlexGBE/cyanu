  ...
  return (
    <>
      ...
      <footer id="cyanu-footer" className="bg-gradient-to-b from-black to-gray-900 text-white relative overflow-hidden">
        {/* Separator Line */}
        <div className="h-0.5 bg-yellow-300 w-full"></div>
        ...
        <div className={`max-w-7xl mx-auto px-8 py-12 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="company-tagline text-yellow-300 text-lg font-semibold mb-4">Building Tomorrow's Software Today</div>
              ...
              <div className="space-y-3">
                <div className="flex items-center text-gray-300 text-sm">
                  <MapPin className="w-4 h-4 mr-3 text-yellow-300" />
                  123 Tech Boulevard, San Francisco, CA 94105
                </div>
                <div className="flex items-center text-gray-300 text-sm">
                  <Phone className="w-4 h-4 mr-3 text-yellow-300" />
                  +1 (555) 123-4567
                </div>
                <div className="flex items-center text-gray-300 text-sm">
                  <Mail className="w-4 h-4 mr-3 text-yellow-300" />
                  hello@cyanu.com
                </div>
                <div className="flex items-center text-gray-300 text-sm">
            ...
            {/* Services Section */}
            <div className="lg:col-span-1">
              <h3 className="text-yellow-300 text-lg font-bold mb-6 relative">
                Our Services
                <div className="absolute -bottom-2 left-0 w-8 h-0.5 bg-yellow-300"></div>
              </h3>
              <ul className="space-y-3">
                {services.map((service, index) => (
                  <li key={index}>
                    <a href="#" className="text-gray-300 text-sm hover:text-yellow-300 transition-colors duration-300 relative group">
                      {service}
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <a
                        key={index}
                        href={social.href}
                        className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:text-yellow-300 hover:bg-gray-700 hover:scale-110 transition-all duration-300"
              ...
              <div>
                ...
                <div className="space-y-3">
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded text-white text-sm focus:border-yellow-300 focus:outline-none transition-colors duration-300"
                  />
                  <button
                    onClick={handleNewsletterSubmit}
                    className="w-full bg-yellow-300 text-black px-4 py-2 rounded font-semibold text-sm hover:bg-yellow-400 hover:shadow-lg transition-all duration-300 flex items-center justify-center group"
                  >
                    Subscribe
          ...
          <div className="border-t border-gray-800 pt-8 mb-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
                <button className="bg-yellow-300 text-black px-6 py-3 rounded-lg font-semibold hover:bg-yellow-400 hover:shadow-lg transition-all duration-300">Start Your Project</button>
                <button className="border border-yellow-300 text-yellow-300 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-300 hover:text-black transition-all duration-300 flex items-center">
        ...
        {/* Copyright Bar */}
        <div className="bg-black border-t border-yellow-300">
