...
import {person1, person2, person3, company1, company2, company3} from "@/assets/images/index";
          ...
          >
            {testimonials.map((t, index) => (
              <SwiperSlide className="z-10" key={index}>
                <div
                  className="group h-[420px] flex flex-col rounded-3xl border border-[#cabb67]/20 hover:border-[#cabb67]/60 bg-gradient-to-br from-white/8 to-white/3 backdrop-blur-sm p-8 transition-all duration-500 hover:transform hover:scale-[1.02] hover:shadow-2xl hover:shadow-[#cabb67]/10"
                  data-aos="zoom-in"
